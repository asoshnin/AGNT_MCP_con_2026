...
playbook_lines.extend([
    ...
    "",
    "The entire project is 100% open-source (Apache 2.0) and runs on free-tier inference and zero-server PII storage.",
    "",
